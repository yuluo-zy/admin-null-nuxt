  ...
  >
    ...
    >
      ...
      <p class="mb-12 text-lg text-gray-500">
        Here is a few of the awesome features we provide.
      </p>
      ...
      <div class="flex w-full h-full">
              ...
              <div class="relative h-full ml-0 mr-0 sm:mr-10">
                ...
                >
                  ...
                  <p class="mb-2 text-gray-600">
                    You can get a quick snapshot of all your analytics on your
                    beautiful dashboard.
                  </p>
                </div>
              </div>
            ...
            <div class="w-full sm:w-1/2">
              <div class="relative h-full ml-0 md:mr-10">
                ...
                >
                  ...
                  <p class="mb-2 text-gray-600">
                    We've got some pretty rad tools to help you take on the
                    world.
                  </p>
                </div>
              </div>
            ...
            <div class="w-full mb-10 sm:mb-0 sm:w-1/2">
              <div class="relative h-full ml-0 mr-0 sm:mr-10">
                ...
                >
                  ...
                  <p class="mb-2 text-gray-600">
                    Collaborating with members of your team couldn't be easier.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="w-full sm:w-1/2">
              <div class="relative h-full ml-0 md:mr-10">
                ...
                >
                  ...
                  <p class="mb-2 text-gray-600">
                    Our automation tools will help you build and grow your
                    marketing empire.
                  </p>
                </div>
              </div>
        ...
        <div class="hidden w-1/3 lg:block">
          <div class="absolute w-full max-w-4xl pl-12 -mt-20 xl:-mt-32">
            <div
              class="absolute top-0 left-0 w-full h-full mt-2 ml-10 bg-gray-900 rounded-2xl"
            ></div>
            <div
              class="relative overflow-hidden border-2 border-black rounded-2xl"
            >
              <img
                src="https://cdn.devdojo.com/images/february2021/task-dashboard.png"
