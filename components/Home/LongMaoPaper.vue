<template>
  <section
    class="relative text-gray-600 body-font w-full py-12 px-12 bg-gray-100 sm:py-20"
  >
    <div class="block px-16 py-10">
    ...
    <div class="flex w-full flex-row">
      <div
        class="flex-1 max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800"
      >
        <img
