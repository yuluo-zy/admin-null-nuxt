<template>
  <section class="w-full bg-gray-900">
    <div class="px-6 mx-auto max-w-7xl xl:px-12">
            ...
            <ul class="p-0 m-0 text-base leading-tight list-none">
              ...
              >
                <a
                  ...
                  ><font style="vertical-align: inherit;"
                    ><font style="vertical-align: inherit;">家</font></font
                  ></a
                >
              </li>
              <li
              ...
              >
                <a
                  ...
                  class="text-base leading-tight no-underline bg-transparent cursor-pointer hover:text-gray-400"
                  ><font style="vertical-align: inherit;"
                    ><font style="vertical-align: inherit;">范本</font></font
                  ></a
                >
              </li>
            </ul>
            ...
            <ul class="p-0 m-0 text-base leading-tight list-none">
              ...
              >
                <a
                  ...
                  class="text-base leading-tight no-underline bg-transparent cursor-pointer hover:text-gray-400"
                  ><font style="vertical-align: inherit;"
                    ><font style="vertical-align: inherit;">文化</font></font
                  ></a
                >
              </li>
              <li
              ...
              >
                <a
                  ...
                  class="text-base leading-tight no-underline bg-transparent cursor-pointer hover:text-gray-400"
                  ><font style="vertical-align: inherit;"
                    ><font style="vertical-align: inherit;">职位</font></font
                  ></a
                >
              </li>
              <li
              ...
              >
                <a
                  ...
                  class="text-base leading-tight no-underline bg-transparent cursor-pointer hover:text-gray-400"
                  ><font style="vertical-align: inherit;"
                    ><font style="vertical-align: inherit;">技术</font></font
                  ></a
                >
              </li>
              <li
              ...
              >
                <a
                  ...
                  class="text-base leading-tight no-underline bg-transparent cursor-pointer hover:text-gray-400"
                  ><font style="vertical-align: inherit;"
                    ><font style="vertical-align: inherit;">安全</font></font
                  ></a
                >
              </li>
            </ul>
            ...
            <ul class="p-0 m-0 text-base leading-tight list-none">
              ...
              >
                <a
                  ...
                  class="text-base leading-tight no-underline bg-transparent cursor-pointer hover:text-gray-400"
                  ><font style="vertical-align: inherit;"
                    ><font style="vertical-align: inherit;">入门</font></font
                  ></a
                >
              </li>
              <li
      ...
      <div
        class="flex flex-col items-center justify-between w-full py-12 text-xs leading-none text-gray-500 border-t border-gray-800 lg:flex-row"
      >
        <div
        ...
        >
          ...
          >
            <a href="#" class="text-gray-400 hover:text-gray-200">
              <span class="sr-only"
                ><font style="vertical-align: inherit;"
                  ><font style="vertical-align: inherit;">Facebook</font></font
                ></span
              >
              <svg
                class="w-6 h-6"
            ...
            <a href="#" class="text-gray-400 hover:text-gray-200">
              <span class="sr-only"
                ><font style="vertical-align: inherit;"
                  ><font style="vertical-align: inherit;">推特</font></font
                ></span
              >
              <svg
                class="w-6 h-6"
            ...
            <a href="#" class="text-gray-400 hover:text-gray-200">
              <span class="sr-only"
                ><font style="vertical-align: inherit;"
                  ><font style="vertical-align: inherit;">的GitHub</font></font
                ></span
              >
              <svg
                class="w-6 h-6"
            ...
            <a href="#" class="text-gray-400 hover:text-gray-200">
              <span class="sr-only"
                ><font style="vertical-align: inherit;"
                  ><font style="vertical-align: inherit;">运球</font></font
                ></span
              >
              <svg
                class="w-6 h-6"
        ...
        >
          ...
          <li class="box-border block font-semibold text-left">
            <a
              ...
              class="pr-5 mr-5 text-gray-500 no-underline bg-transparent border-r border-gray-700 cursor-pointer"
              ><font style="vertical-align: inherit;"
                ><font style="vertical-align: inherit;">隐私政策</font></font
              ></a
            >
          </li>
          <li class="box-border block font-semibold text-left">
            <a
              ...
              class="pr-5 mr-5 text-gray-500 no-underline bg-transparent border-r border-gray-700 cursor-pointer"
              ><font style="vertical-align: inherit;"
                ><font style="vertical-align: inherit;">执照</font></font
              ></a
            >
          </li>
          <li class="box-border block font-semibold text-left">
