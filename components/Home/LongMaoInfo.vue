<template>
  <!-- Section 1 -->
  <section
    class="flex items-center justify-center py-28 bg-gray-100 min-w-screen"
  >
    <div class="max-w-6xl px-12 mx-auto bg-gray-100 md:px-16 xl:px-10">
      <div class="flex flex-col items-center lg:flex-row">
        ...
        >
          <p
            class="mb-2 text-base font-medium tracking-tight text-yellow-500 uppercase"
          >
          ...
          <a
            href="#_"
            class="flex items-center justify-center px-8 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-yellow-500 border border-transparent rounded-md shadow hover:bg-yellow-400 focus:outline-none focus:border-yellow-600 focus:shadow-yellow-NaN md:py-4 md:text-lg md:px-10"
            >View Case Studies</a
          >
        </div>
          ...
          >
            <div class="flex flex-col pr-8">
              <div class="relative pl-12">
                <svg
                  class="absolute left-0 w-10 h-10 text-yellow-500 fill-current"
